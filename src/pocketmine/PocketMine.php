...
namespace pocketmine {
	...
	const SLEEP_API_VERSION = '1.0.0';
	const CODENAME = "vk.com/nubix";
	...
	if(!flock(\pocketmine\LOCK_FILE, LOCK_EX | LOCK_NB)){
		...
		echo "[CRIT] Another SleepPro instance (PID $pid) is already using this folder (" . realpath(\pocketmine\DATA) . ")." . PHP_EOL;
	...
	$logger->notice("Остановка остальных процессов.");
